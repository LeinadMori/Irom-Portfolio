...
const PROCESS = ["Brief", "Concept", "Script", "Prompt", "Visual", "Final Ad"];

const PROMPTS = [
  "A close-up of dew forming on a chilled bottle at golden hour...",
  "Cinematic tracking shot through a Lagos market at dusk...",
  "Product hero shot, studio lighting, deep shadow, matte finish...",
];
  ...
  return (
    <div style={{ minHeight: "100vh", background: theme.bg, color: theme.text, fontFamily: theme.bodyFont }}>
      ...
      >
        ...
        >
          Ideas become campaigns.
        </motion.h1>
        <p style={{ maxWidth: "480px", margin: "0 auto", color: theme.dim, fontSize: "14.5px", lineHeight: 1.7 }}>
          From brief to finished commercial — every ad here started as a prompt.
        </p>
      </div>

      {/* Process rail — a real sequence, so numbering earns its place */}
      ...
      <div style={{ maxWidth: "700px", margin: "0 auto", padding: "0 40px 70px" }}>
        <h2 style={{ fontFamily: theme.displayFont, fontSize: "20px", marginBottom: "16px" }}>Behind the Prompt</h2>
        <TypingPrompt />
      </div>

      {/* Featured campaigns — each card links to its own detail page */}
      <div style={{ maxWidth: "1000px", margin: "0 auto", padding: "0 40px 100px" }}>
        <h2 style={{ fontFamily: theme.displayFont, fontSize: "20px", marginBottom: "24px" }}>Featured Campaigns</h2>
            ...
            >
              <Link to={`/ai-studio/${c.slug}`} style={{ textDecoration: "none", color: "inherit" }}>
                ...
                >
                  ...
                  <span style={{ fontFamily: theme.displayFont, fontSize: "15px", fontWeight: 600, textShadow: "0 1px 6px rgba(0,0,0,0.6)" }}>
                    {c.name}
                  </span>
                </div>
              </Link>
